...
The FARE principles are a starting point for defining best practice, or the `gold standard' for academic software outputs. An exemplar of the application of these principles is described in the authors' recent paper, `ABC: Using Object Tracking to Automate Behavioural Coding', published at the 2016 ACM CHI conference. The source code is openly available on Github, making it accessible and extensible, and both this and the software environment (in a Docker container), are identified by DOIs, making the software findable and reusable.
