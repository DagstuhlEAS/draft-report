...
We came together to contribute to the FORCE11 software citation principles. From the website at \url{https://www.force11.org/software-citation-principles} we quote: ``Based on a review of existing community practices, the goal of [FORCE11] was to produce a consolidated set of citation principles that may encourage broad adoption of a consistent policy for software citation across disciplines and venues.''
...
Dan reported recently that this review has been passed on to the FORCE11 Software Citation Working Group editors, leading to an update to the citation principles where deemed necessary.
