...
\titlerunning{14112 -- Perspectives Workshop: Engineering Academic Software}%optional
...
\author[2]{Claude Kirchner}
  \affil[2]{Inria, France   \url{mailto:claude.kirchner@inria.fr}}

\author[3]{Oscar Nierstrasz}
  \affil[3]{Stanford University, USA  \url{mailto:Claude.Kirchner@inria.fr}}

\author[4]{James Howison}
  \affil[4]{The University of Texas at Austin, USA  \url{mailto:jhowison@ischool.utexas.edu}}
