...
To produce sustainable software requires sustaining the team that produces it. \katznote{I don't agree with this, since new people can take over and continue an existing project when the original team stops working on it.  Even with the note at the end of this paragraph, I still don't think this is correct as written.}
...
Appreciation for software seems more natural in Computer Science, which explains recent efforts in this field to making the impact of software visible. An important positive factor is the recent focus in research towards ``innovation'' and ``valorization'' which puts tangible and transferable results of Computer Science in the form of working software in the spotlight. Bio-Informatics though, is ahead of the pack, which may be due to its explicit branding as a the informatics branch of Biology. \jv{I couldn't help but add some thoughts to this previous paragraph. Please remove if it's too much} \katznote{I actually don't think CS is a special case that is ahead of other fields.  There are folks in a number of fields who are pushing ahead, CS is just one of these, and in many parts of CS, there is no appreciation of software.}
...
\abstractauthor{Dan Katz, et al.\jv{et al. is not nice. who was there?}\katznote{I don't remember - there must be notes?}}
