...
Katz presented an overview of work done by the Force11 Software Citation Working Group.\footnote{\url{https://www.force11.org}}
...
It also includes the six principles themselves, which focus on
(i) the importance of software, 
(ii) the need to credit and attribute the contributions software makes to research, % and 
(iii) to be able to uniquely identify software in a persistent and specific way, and 
(iv) that citations should enable access to the software and associated information about the software that informs its use.
...
Taken from a presentation given at the National Library of Medicine (USA), this Open Mic talk gives a quick overview of the Astrophysics Source Code Library (ASCL) and how it seeks to make research software used in astronomy more discoverable. It covers the changes in the ASCL over time and its impact.
